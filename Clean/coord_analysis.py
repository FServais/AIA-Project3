"""
This script aims at testing and tuning parameters by obtaining a bias, a variance
and a mean squared error by method/parameter used.
"""
...
if __name__ == "__main__":
    ...
    data = data_read.sample(frac=0.7)
