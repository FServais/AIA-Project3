...
"""
This script aims at predicting the destination of a taxi given a subpath in a
very simple way, by using a KNeighborsRegressor.
"""
...
if __name__ == "__main__":
    ...
    # Data Loading
    data = pd.read_csv('train_data.csv', index_col="TRIP_ID", nrows=8000)
