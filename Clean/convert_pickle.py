"""
This script aims at producing a 'pickle' file containing the pandas dataframe
...
if __name__ == "__main__":
    ...
    # Data Loading
    test = pd.read_csv('test.csv', index_col="TRIP_ID", nrows=400)
    ...
    # Data Loading
    data = pd.read_csv('train_data.csv', index_col="TRIP_ID", nrows=400)
