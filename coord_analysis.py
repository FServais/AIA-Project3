...
if __name__ == "__main__":
    ...
    for train_index, test_index in kf:
        ...
        knn_25 = DecisionTreeRegressor(max_depth=10)
        knn_50 = DecisionTreeRegressor(max_depth=10)
        knn_100 = DecisionTreeRegressor(max_depth=10)
        knn_plus = DecisionTreeRegressor(max_depth=10)
        ...
        e.append(np.mean([mae(np.array(y_predict[0]), y_ls), bias(np.array(y_predict[1]), y_ls)]))
